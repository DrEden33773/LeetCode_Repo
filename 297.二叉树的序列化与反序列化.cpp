...
public:
    ...
    vector<vector<string>> older_serialize(TreeNode* node) {
    ...
    vector<string> serialize(TreeNode* node) {
        vector<string> res;
    ...
    TreeNode* older_deserialize(const vector<vector<string>>& data) {
    ...
    TreeNode* deserialize(const vector<string>& data) {
        ...
        for (const string& node_info : data) {
            TreeNode* curr_node = (node_info == "#")
                ? nullptr
                : new TreeNode(stoi(node_info));
